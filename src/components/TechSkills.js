        ...
        <section className="py-12 px-4 max-w-5xl max-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4">
                {skills.map((skill, index) =>(
                    <div key={index} className="bg-gray-900/80 border border-gary-800 hover:border-purple-500 rounded-xl p-4 transition-all durantion-300 hover:-translate-y-1 hover:shadow-[0_0_15px_rgba(168,85,247,0.2)] flex flex-col justify-center">
