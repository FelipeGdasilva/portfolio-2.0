      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="p-5 rounded-xl bg-slate-800/50 border border-slate-700/50 flex flex-col justify-between">
          <div>
            ...
            <p className="text-slate-300 text-sm leading-relaxed mb-4">
              Desenvolvedor Fullstack com foco em criar soluções modernas e
              interativas utilizando{" "}
              <strong>
                React, Next.js, JavaScript e automações inteligentes
              </strong>
              .
            </p>
            <p className="text-slate-300 text-sm leading-relaxed mb-6">
              Especializado na construção de aplicações ricas em experiência de
              usuário (UI/UX) e na integração de sistemas dinâmicos.
            </p>
          </div>
          ...
          <div>
            <a
              href="/Currículo-Felipe-Gomes.pdf"
              download="Currículo-Felipe-Gomes.pdf"
        ...
        <div className="p-5 rounded-xl bg-purple-950/30 border border-purple-800/40 flex flex-col justify-between">
          <div>
            ...
            <p className="text-slate-300 text-sm leading-relaxed mb-4">
              A <strong>Hina</strong> é a assistente virtual e copiloto deste
              portfólio. Ela foi projetada para interagir com os visitantes,
              responder perguntas sobre mim e navegar pelos projetos em tempo
              real.
            </p>
          </div>
          <div>
            <span className="inline-block px-3 py-1 text-xs rounded-full bg-purple-500/20 text-purple-300 border border-purple-500/30">
              Status: Pronta para interagir • Hina Online 🚀
            </span>
          </div>
        </div>
      </div>
